...
if __name__ == '__main__':
    with sessionmaker(engine).begin() as session:
        ...
        d2 = Department(name="重庆分公司", city="重庆", parent=d1)
        d3 = Department(name="成都分公司", city="成都", parent=d1)

        e1 = Employee(name="张三", age=23, salary=3000, gender=GenderEnum.MALE.value, job_time="2018-01-01",
                      department=d1)
        e2 = Employee(name="李四", age=23, salary=3000, gender=GenderEnum.MALE.value, job_time="2018-03-01",
                      department=d2)
        e3 = Employee(name="王五", age=23, salary=3000, gender=GenderEnum.MALE.value, job_time="2019-03-01",
                      department=d3)
